...
export default component$(() => {
	...
	return (
		<div
			class="bg-white shadow-xl sticky top-0 z-10 animate-dropIn"
		>
			<header>
							...
							<div>
								<p class="hidden sm:block">
									...
									<a
										...
										class="underline"
									>
										{$localize`Serenity - Bolsa Executivo Couro Napa`}
									</a>
								</p>
							</div>
				...
				<div class="max-w-6xl text-black-100 mx-auto p-4 flex items-center space-x-4">
					<button
					...
					<h1 class="text-white">
						<Link href="/">
							<img src={`/logo-48-48.png`} width={48} height={48} alt="Salime logo" />
						</Link>
					</h1>
					<div class="hidden space-x-4 sm:block">
						{collections.map((collection) => (
							<Link
								class="text-sm md:text-base text-gray-800 hover:text-white"
					...
					<div class="">
						<button
							...
							class="relative w-9 h-9 bg-black bg-opacity-20 rounded text-white p-1"
